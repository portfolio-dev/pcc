...
function submitConfirmation() {
  ...
  // URL Google Form
  const googleFormURL = 'https://docs.google.com/forms/u/0/d/e/1FAIpQLScs44lz3dQs6ms2ldcclok4IXTbAiF3JQB-ATI4XykACRfCkQ/formResponse';
  ...
  setTimeout(() => {
      window.location.href = '../sent.html'; // Arahkan ke index.html setelah beberapa detik
